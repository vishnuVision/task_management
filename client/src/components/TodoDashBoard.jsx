...
function TodoDashBoard() {
  ...
  const { completedList, inCompletedList, inProgressList, refreshData, page, setPage, todoList } = useContext(getDetails);
  ...
  return (
    <div className="relative flex flex-col mt-20 ms-2 flex-grow justify-evenly">
      ...
      {
        isList &&
        <div className="relative overflow-scroll w-[40%] xxs:w-[50%] xs:w-[50%] sm:w-[90%] md:w-[90%] lg:w-[95%] my-4 mx-2 sm:mx-5 md:mx-10">
